...
KNOWN_ARTICLE_CONTENT_TAGS = [
    ...
    {'attr': 'class', 'value': 'act-blog-post-body'},
    {'attr': 'class', 'value': 'post-body'},
    {'attr': 'class', 'value': 'post-text'},
    {'attr': 'class', 'value': 'post_content'},
    {'attr': 'class', 'value': 'entry'},
    {'attr': 'class', 'value': 'blog-content'},
    {'attr': 'class', 'value': 'article'},
    {'attr': 'class', 'value': 'post-entry-single'},
    {'attr': 'class', 'value': 'post-entry'},
    {'attr': 'class', 'value': 'bSeCont'},
    {'attr': 'class', 'value': 'tve-tl-cnt-wrap'},
    {'attr': 'class', 'value': 'page-body-inner'},
    {'attr': 'class', 'value': 'mk-single-content'},
    {'attr': 'class', 'value': 'pagecontent'},
    {'attr': 'class', 'value': 'article-body'},
    {'attr': 'class', 'value': 'postarea'},
    {'attr': 'class', 'value': 'the-content'},
    {'attr': 'class', 'value': 's28inlineContent'},
    {'attr': 'class', 'value': 'field-name-body'},
    {'attr': 'id', 'value': 'content-area'},
    {'attr': 'id', 'value': 'post-border'},
    {'attr': 'id', 'value': 'main-panel'},
    {'attr': 'id', 'value': 'quatablecontent'},
    {'attr': 'class', 'value': 'page-content'},
    {'attr': 'class', 'value': 'post-servicebox-left'},
    {'attr': 'class', 'value': 'post_content_holder'},
    {'attr': 'class', 'value': 'viewitem-content'},
    {'attr': 'class', 'value': 'blog-post'},
    {'attr': 'class', 'value': 'blogBody'},
    {'attr': 'class', 'value': 'layout_centered_2col_main'},
    {'attr': 'class', 'value': 's76'},
    {'attr': 'class', 'value': 'pane-node-body'},
    {'attr': 'class', 'value': 'w-blogpost-text'},
    {'attr': 'class', 'value': 'article-text'},
    {'attr': 'class', 'value': 'w-blogpost-text'},
    {'attr': 'class', 'value': 'post_text_inner'},
    {'attr': 'class', 'value': 'sumome-article'},
    {'attr': 'class', 'value': 'entry_body'},
    {'attr': 'class', 'value': 'center-content'},
